package com.itheima.Runtime_method;
...
public class RuntimeTest {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //3.public int availableProcessirs() 获取虚拟机能够使用的处理器数
        ...
        Process p=r.exec("D:\\soft\\PotPlayer\\PotPlayerMini64.exe");
        //r.exec("QQ");qq必须已经配置在系统变量中
